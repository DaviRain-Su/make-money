...
<div class=\"card\">
  <h3 style=\"margin-top:0\">按合约敞口 + 强平距离</h3>
  <table>
    <thead><tr><th>合约</th><th>方向</th><th>名义 (USD)</th><th>markPx</th><th>liqPx</th><th>距离</th></tr></thead>
    <tbody id=\"positions-body\"><tr><td colspan=\"6\" style=\"color:#8b95a2\">暂无持仓</td></tr></tbody>
  </table>
</div>
<div class=\"card\">
